  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            width: '100%',
            padding: '16px',
            background: loading ? '#94a3b8' : 'linear-gradient(135deg, #1B365D, #2D4A7C)',
            color: 'white',
            border: 'none',
            borderRadius: '8px',
            fontSize: '16px',
          ...
          onMouseOver={(e) => {
            if (!loading) {
              ...
              e.currentTarget.style.boxShadow = '0 6px 16px rgba(27, 54, 93, 0.4)';
            }
          }}
          onMouseOut={(e) => {
            e.currentTarget.style.transform = 'translateY(0)';
            e.currentTarget.style.boxShadow = '0 4px 12px rgba(27, 54, 93, 0.3)';
          }}
        >
      ...
      <div style={{
        ...
        <p>
          This is a CLEAN test page with NO cache issues •
          Inline styles •
