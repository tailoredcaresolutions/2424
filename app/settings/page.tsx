        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-4 pt-4">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="touch-target liquid-glass-gold text-white rounded-glass-lg px-8 py-4 font-bold text-lg transition-all focus:outline-none focus:ring-4 focus:ring-[var(--tcs-gold)]/50"
            >
              Save Preferences
            </button>
          </div>
