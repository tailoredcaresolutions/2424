...
- [ ] **Primary Blue (#1B365D) on White**: __:1 (target: ≥4.5:1)
- [ ] **Primary Gold (#D4A574) on White**: __:1 (target: ≥4.5:1)
- [ ] **White text on Primary Blue**: __:1 (target: ≥4.5:1)
- [ ] **White text on Primary Gold**: __:1 (target: ≥4.5:1)
- [ ] **Gray text (timestamps)**: __:1 (target: ≥4.5:1)
- [ ] **Link colors**: __:1 (target: ≥4.5:1)
